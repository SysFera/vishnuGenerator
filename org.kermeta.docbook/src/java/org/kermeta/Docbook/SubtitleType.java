 ...
 * <ul>
 *   <li>{@link org.kermeta.Docbook.SubtitleType#getMixed <em>Mixed</em>}</li>
 *   <li>{@link org.kermeta.Docbook.SubtitleType#getGroup <em>Group</em>}</li>
 *   <li>{@link org.kermeta.Docbook.SubtitleType#getEmphasis <em>Emphasis</em>}</li>
 *   <li>{@link org.kermeta.Docbook.SubtitleType#getPhrase <em>Phrase</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.kermeta.Docbook.DocbookPackage#getSubtitleType()
...
public interface SubtitleType extends EObject {
	 ...
	 * @see org.kermeta.Docbook.DocbookPackage#getSubtitleType_Mixed()
	 ...
	 * @see org.kermeta.Docbook.DocbookPackage#getSubtitleType_Group()
	 ...
	 * @see org.kermeta.Docbook.DocbookPackage#getSubtitleType_Emphasis()
	 ...
	 * @see org.kermeta.Docbook.DocbookPackage#getSubtitleType_Phrase()
	 * @model containment="true" transient="true" volatile="true" derived="true"
