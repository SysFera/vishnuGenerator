 ...
 *   <li>{@link org.kermeta.Docbook.impl.ParaTypeImpl#getItemizedlist <em>Itemizedlist</em>}</li>
 *   <li>{@link org.kermeta.Docbook.impl.ParaTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.kermeta.Docbook.impl.ParaTypeImpl#getVariablelist <em>Variablelist</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParaTypeImpl extends EObjectImpl implements ParaType {
	...
	/**
	 * The cached value of the '{@link #getVariablelist() <em>Variablelist</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getVariablelist()
	 * @generated
	 * @ordered
	 */
	protected EList<VariableListType> variablelist;
	...
	public EList<ItemizedlistType> getItemizedlist() {
		return getMixed().list(DocbookPackage.Literals.PARA_TYPE__ITEMIZEDLIST);
	}
	...
	public EList<VariableListType> getVariablelist() {
		if (variablelist == null) {
			variablelist = new EObjectContainmentEList<VariableListType>(VariableListType.class, this, DocbookPackage.PARA_TYPE__VARIABLELIST);
		}
		return variablelist;
	}
