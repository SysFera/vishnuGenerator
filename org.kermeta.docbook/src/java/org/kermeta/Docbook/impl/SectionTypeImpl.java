 ...
 *   <li>{@link org.kermeta.Docbook.impl.SectionTypeImpl#getFuncsynopsis <em>Funcsynopsis</em>}</li>
 *   <li>{@link org.kermeta.Docbook.impl.SectionTypeImpl#getCaution <em>Caution</em>}</li>
 *   <li>{@link org.kermeta.Docbook.impl.SectionTypeImpl#getExample <em>Example</em>}</li>
 *   <li>{@link org.kermeta.Docbook.impl.SectionTypeImpl#getCmdsynopsis <em>Cmdsynopsis</em>}</li>
 *   <li>{@link org.kermeta.Docbook.impl.SectionTypeImpl#getAnnotations <em>Annotations</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SectionTypeImpl extends EObjectImpl implements SectionType {
	...
	public NotificationChain basicSetExample(ExampleType newExample, NotificationChain msgs) {
		ExampleType oldExample = example;
		example = newExample;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DocbookPackage.SECTION_TYPE__EXAMPLE, oldExample, newExample);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setExample(ExampleType newExample) {
		if (newExample != example) {
			NotificationChain msgs = null;
			if (example != null)
				msgs = ((InternalEObject)example).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DocbookPackage.SECTION_TYPE__EXAMPLE, null, msgs);
			if (newExample != null)
				msgs = ((InternalEObject)newExample).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DocbookPackage.SECTION_TYPE__EXAMPLE, null, msgs);
			msgs = basicSetExample(newExample, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.SECTION_TYPE__EXAMPLE, newExample, newExample));
	}
	...
	public EList<CmdsynopsisType> getCmdsynopsis() {
		return getGroup().list(DocbookPackage.Literals.SECTION_TYPE__CMDSYNOPSIS);
	}
	...
	public EList<FuncsynopsisType> getFuncsynopsis() {
		return getGroup().list(DocbookPackage.Literals.SECTION_TYPE__FUNCSYNOPSIS);
	}
