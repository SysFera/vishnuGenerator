 ...
 * <ul>
 *   <li>{@link org.kermeta.Docbook.impl.FileNameTypeImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link org.kermeta.Docbook.impl.FileNameTypeImpl#getReplaceable <em>Replaceable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FileNameTypeImpl extends EObjectImpl implements FileNameType {
	...
	protected EClass eStaticClass() {
		return DocbookPackage.Literals.FILE_NAME_TYPE;
	}
	...
	public FeatureMap getMixed() {
		if (mixed == null) {
			mixed = new BasicFeatureMap(this, DocbookPackage.FILE_NAME_TYPE__MIXED);
		}
		return mixed;
	}
	...
	public EList<ReplaceableType> getReplaceable() {
		return getMixed().list(DocbookPackage.Literals.FILE_NAME_TYPE__REPLACEABLE);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DocbookPackage.FILE_NAME_TYPE__MIXED:
				return ((InternalEList<?>)getMixed()).basicRemove(otherEnd, msgs);
			case DocbookPackage.FILE_NAME_TYPE__REPLACEABLE:
