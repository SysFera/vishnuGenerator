 ...
 *   <li>{@link org.kermeta.Docbook.impl.DocumentRootImpl#getInfo <em>Info</em>}</li>
...
public class DocumentRootImpl extends EObjectImpl implements DocumentRoot {
	...
	public InfoType getInfo() {
		return (InfoType)getMixed().get(DocbookPackage.Literals.DOCUMENT_ROOT__INFO, true);
	}
	...
	public NotificationChain basicSetInfo(InfoType newInfo, NotificationChain msgs) {
		return ((FeatureMap.Internal)getMixed()).basicAdd(DocbookPackage.Literals.DOCUMENT_ROOT__INFO, newInfo, msgs);
	}
	...
	public void setInfo(InfoType newInfo) {
		((FeatureMap.Internal)getMixed()).set(DocbookPackage.Literals.DOCUMENT_ROOT__INFO, newInfo);
	}
