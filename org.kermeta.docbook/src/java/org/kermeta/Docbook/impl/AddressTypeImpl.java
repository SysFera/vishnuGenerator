 ...
 *   <li>{@link org.kermeta.Docbook.impl.AddressTypeImpl#getEmail <em>Email</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddressTypeImpl extends EObjectImpl implements AddressType {
	...
	public void setEmail(String newEmail) {
		...
		email = newEmail;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DocbookPackage.ADDRESS_TYPE__EMAIL, oldEmail, email));
	}
