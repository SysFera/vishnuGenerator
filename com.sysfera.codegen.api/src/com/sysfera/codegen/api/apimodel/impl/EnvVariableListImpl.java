...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Env Variable List</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link com.sysfera.codegen.api.apimodel.impl.EnvVariableListImpl#getEnvVariables <em>Env Variables</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EnvVariableListImpl extends EObjectImpl implements EnvVariableList {
	/**
	...
	protected EClass eStaticClass() {
		return ApimodelPackage.Literals.ENV_VARIABLE_LIST;
	}
	...
	public EList<EnvVariable> getEnvVariables() {
		if (envVariables == null) {
			envVariables = new EObjectContainmentEList<EnvVariable>(EnvVariable.class, this, ApimodelPackage.ENV_VARIABLE_LIST__ENV_VARIABLES);
		}
		return envVariables;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ApimodelPackage.ENV_VARIABLE_LIST__ENV_VARIABLES:
